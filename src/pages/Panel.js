        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h1 className="text-center">{selectedTab}</h1>
            </div>
            <div className="col-sm-12">
              <Tab.Container id="left-tabs-example" onSelect={handleSelectedTab} defaultActiveKey="studentList">
                <Row>
                  <Col sm={3}>
                    <Nav variant="pills" className="flex-column">
                      ...
                      <Nav.Item>
                        <Nav.Link eventKey="changeProfileImage">Cambiar imágen de perfil</Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                  ...
                  <Col sm={9}>
                    <Tab.Content>
                      ...
                      <Tab.Pane eventKey="changeProfileImage">
                        <h2>Aca ira para cambiar de imagen</h2>
                      </Tab.Pane>

                      <Tab.Pane eventKey="invite">
                        <h5 className="text-center">Usa este código QR para invitar a tus alumnos!</h5>
                        <div className="text-center">
                          <QRCode id="qrcode" value={inviteQR} size={290} level={"H"} includeMargin={true} />
                        </div>
